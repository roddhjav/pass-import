...
_pass-import () {
	if (( CURRENT > 2)); then
		...
		# subcommands begin
		subcommands=(
			'1password:Importer for 1password in 1PIF v4, CSV v4, CSV v6'
			...
			'bitwarden:Importer for bitwarden in JSON, CSV'
			...
			'pass:Importer & Exporter for pass in PASS'
			'passman:Importer for passman in JSON, CSV'
